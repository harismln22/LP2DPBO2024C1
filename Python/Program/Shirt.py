...
class Shirt(Clothing):
    ...
    # print semua input baju yang sudah dibuat
    def tampil (self,listShirt):
        if listShirt: # inisialisasi semua nama label tabel untuk perbandingan nanti
            ...
            for shirt in listShirt: # mengambil string terpanjang jika ada
            ...
            for shirt in listShirt: # loop semua isi listShirt
